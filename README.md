# Magento 2 Multiple Coupons Discounts Extension
...
* Ability to apply one or multiple coupons codes at the cart and checkout pages
* Display all applied coupons in the cart and checkout pages
* Ability to apply one or multiple coupons in backend (order view/create pages)
* Display all applied coupons in the backend (order view/create pages)
* Ability to remove/cancel applied coupons with a single slick
* Ability set a list of unique coupons codes that can be applied
* Ability to define a brief note to appears under the coupon code field at frontend (cart & checkout pages) and backend (order create pages)
* Support multistore
* Mobile-friendly


<img src="https://www.ulmod.com/media/ulmod/product_content/multicoupon-front-f.png">
